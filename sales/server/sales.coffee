Meteor.startup ->
  ...
  if joe
    ...
    Accounts.createUser
      email: "joe@dwtestonly.com"
      password: "abc123"

  sing = Meteor.users.findOne("emails.address": "sing@dwtestonly.com")
  if sing
  ...
  Meteor.publish "global_sales", ->
    if @userId # only visible to logged in users
      Sales2013.find {}, # restrict the owner field from client access
        fields:
          region: 1
          total: 1
